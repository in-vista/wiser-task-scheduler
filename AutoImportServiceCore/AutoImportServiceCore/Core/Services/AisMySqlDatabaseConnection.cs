...
{
    public class AisMySqlDatabaseConnection : IDatabaseConnection, IScopedService
    {
        private readonly ILogger<AisMySqlDatabaseConnection> logger;
        ...
        /// </summary>
        public AisMySqlDatabaseConnection(IOptions<GclSettings> gclSettings, ILogger<AisMySqlDatabaseConnection> logger)
        {
            this.logger = logger;
