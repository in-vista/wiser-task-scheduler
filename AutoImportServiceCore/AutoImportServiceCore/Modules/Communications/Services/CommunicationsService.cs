...
public class CommunicationsService : ICommunicationsService, IActionsService, IScopedService
{
    ...
    {
	    var communicationSettings = new List<CommunicationSettingsModel>(); //await gclCommunicationsService.GetSettingsAsync(communication.Type);
	    communicationSettings.Add(new CommunicationSettingsModel()
	    {
		    Id = 1,
		    Name = "Test",
		    SendTriggerType = SendTriggerTypes.Direct,
		    TriggerStart = DateTime.Now,
		    ReceiversDataSelectorId = 31,
		    Settings = new List<CommunicationContentSettingsModel>()
		    {
			    new CommunicationContentSettingsModel()
			    {
...
This email has been generated by the AIS to test this new functionality.
Because your email address was one of the results from the data selector you received this email.

I wish you a great day.
"
			    }
		    },
		    LastProcessed = new List<LastProcessedModel>()
		    {
			    new LastProcessedModel()
			    {
				    Type = CommunicationTypes.Email,
